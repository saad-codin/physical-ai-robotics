...
async def respond(
    ...
    async for event in stream_widget(
        ...
        yield event
ChatKit ships with a wide set of widget nodes (cards, forms, text, buttons, and more). See widgets guide on GitHub for all components, props, and streaming guidance.
